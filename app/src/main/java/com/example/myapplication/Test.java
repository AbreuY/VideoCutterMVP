...
public class Test {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("timescale is: " + movie.getTimescale());

            List<Track> tracks = movie.getTracks();


            System.out.println("tracks size is: " + tracks.size());
            for (Track a : tracks) {
                System.out.println("length is: " + a.getDuration() + "name: " + a.getName());
