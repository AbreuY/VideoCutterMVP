...
public class Cutter {
    ...
    Cutter(File file, Context context) {
        try {

            //   Movie movie = MovieCreator.build(video.toString());
            //  Movie movie = MovieCreator.build("c:\\temp\\test\\\\testtest.mp4");

            Log.e("xxx", "file path is: " + file.getPath());

            Movie movie = MovieCreator.build(new FileDataSourceImpl(file));

            Log.e("xxx", "length is: " + movie.getTimescale());
            ...
            FileOutputStream fos = new FileOutputStream(VideoFileUtils.INSTANCE.getPublicSpaceDirPath(context) + "/" + "newFile.mp4");
            ...
            File directory = new File(VideoFileUtils.INSTANCE.getMediaCacheDirPath(context));

            File[] files = directory.listFiles();

            Log.e("xxxx", "files length is: " + files.length);

            for (File a: files) {
                Log.e("xxxx", "file name is : " + a.getName());
            }
